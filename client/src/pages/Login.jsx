...
// Full-screen adaptive login — two-column split layout
    ...
    <div className="login-page">
      ...
      <div className="login-brand-panel">
        ...
        <div className="login-brand-inner">
          ...
          <p className="login-brand-desc">
            Manage appointments, staff, inventory &amp; analytics — all in one place.
          </p>

          <div className="login-features">
            {['📅 Smart Scheduling', '💰 POS & Billing', '📊 Live Analytics', '🤖 AI Assistant'].map(f => (
      ...
      <div className="login-form-panel">
        <div className="login-form-inner">
          ...
          <p className="login-form-sub">Sign in to your StyleSynk account</p>
